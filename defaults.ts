export const MLX_OPENAI_SERVER_PROVIDER_ID = "mlx-openai-server";
...
export const MLX_OPENAI_SERVER_DOCS_URL =
  "https://github.com/cubist38/mlx-openai-server-openclaw-plugin#readme";
